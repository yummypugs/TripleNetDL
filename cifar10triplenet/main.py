...
class Solver(object):
    ...
    def load_model(self):
        ...
        num_params = sum(p.numel() for p in self.model.parameters() if p.requires_grad) ## DL: This is our addition
        print(f"The model has {num_params} trainable parameters.") ## DL: This is our addition
